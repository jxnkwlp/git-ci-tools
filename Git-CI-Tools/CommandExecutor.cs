    ...
    public VersionCurrentCommandResult VersionCurrent(VersionCurrentCommandOptions options)
    {
        ...
        if (options.Format == "json")
        {
            outputText = JsonSerializer.Serialize(new
            {
                ...
                ShortVersion = currentVersion.WithoutMetadata(),
            });
        }
        else if (options.Format == "dotenv")
        {
            ...
            sb.AppendLine($"{name}_MINI={currentVersion.WithoutMetadata()}");
            sb.AppendLine($"{name}_SHORT={currentVersion.WithoutMetadata()}");
            ...
            sb.AppendLine($"{name}_BUILD={currentVersion.Metadata}");
    ...
    public VersionNextCommandResult VersionNext(VersionNextCommandOptions options)
    {
        ...
        if (options.Format == "json")
        {
            outputText = JsonSerializer.Serialize(new
            {
                ...
                nextVersion.Metadata,
                FullSemVersion = nextVersion.ToString(),
                VersionInfo = nextVersion.ToString(),
                ShortVersionInfo = nextVersion.WithoutMetadata().ToString()
            });
        }
        else if (options.Format == "dotenv")
        {
            ...
            sb.AppendLine($"{name}_MINI={nextVersion.WithoutMetadata()}");
            sb.AppendLine($"{name}_SHORT={nextVersion.WithoutMetadata()}");
            ...
            sb.AppendLine($"{name}_BUILD={nextVersion.Metadata}");
