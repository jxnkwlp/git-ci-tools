...
namespace Git_CI_Tools
{
    public class GitContext
    {
        ...
        public IReadOnlyList<GitCommit> GetCommits(string branch = null, string fromSha = null)
        {
            ...
            return resultCommits.Select(x => new GitCommit()
            {
                ...
                ChangedFiles = GetChangedFiles(_repository, x),
            }).ToList();
        }

        private IReadOnlyList<GitChangedFile> GetChangedFiles(Repository repo, Commit commit)
        {
    ...
    public class GitCommit
    {
        ...
        public IReadOnlyList<GitChangedFile> ChangedFiles { get; set; }
